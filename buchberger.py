...
def buchberger(F, S=None, selection='degree', elimination='gebauermoeller', rewards='additions', sort_reducers=True, gamma=0.99):
...
class LeadMonomialsEnv:
    ...
    def value(self, strategy='degree', gamma=0.99):
        return self.env.value(strategy,gamma)
